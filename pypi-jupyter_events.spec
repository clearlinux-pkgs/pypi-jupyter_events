...
Source0  : https://files.pythonhosted.org/packages/f4/65/5791c8a979b5646ca29ea50e42b6708908b789f7ff389d1a03c1b93a1c54/jupyter_events-0.11.0.tar.gz
...
%prep
%setup -q -n jupyter_events-0.11.0
cd %{_builddir}/jupyter_events-0.11.0
pushd ..
cp -a jupyter_events-0.11.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1735096511
