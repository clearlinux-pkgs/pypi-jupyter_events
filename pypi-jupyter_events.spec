...
Version  : 0.6.2
Release  : 5
URL      : https://files.pythonhosted.org/packages/78/37/f5416662ba163dfccec85be05068c23f4a4afb02178bde520dcd232a52bd/jupyter_events-0.6.2.tar.gz
Source0  : https://files.pythonhosted.org/packages/78/37/f5416662ba163dfccec85be05068c23f4a4afb02178bde520dcd232a52bd/jupyter_events-0.6.2.tar.gz
...
%prep
%setup -q -n jupyter_events-0.6.2
cd %{_builddir}/jupyter_events-0.6.2
pushd ..
cp -a jupyter_events-0.6.2 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1673454184
