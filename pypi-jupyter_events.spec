...
Version  : 0.6.0
Release  : 3
URL      : https://files.pythonhosted.org/packages/5c/0d/cd700d9e3c7954d49b806be35eae6c311e0da7374ba2b5521b6af2da9ae9/jupyter_events-0.6.0.tar.gz
Source0  : https://files.pythonhosted.org/packages/5c/0d/cd700d9e3c7954d49b806be35eae6c311e0da7374ba2b5521b6af2da9ae9/jupyter_events-0.6.0.tar.gz
...
%prep
%setup -q -n jupyter_events-0.6.0
cd %{_builddir}/jupyter_events-0.6.0
pushd ..
cp -a jupyter_events-0.6.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1673369339
