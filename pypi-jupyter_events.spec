...
Version  : 0.9.1
Release  : 12
URL      : https://files.pythonhosted.org/packages/79/2f/552806e72d8ca94a4ee6645d3fe7208cba0d3394c74c7b178fb4eac29fa7/jupyter_events-0.9.1.tar.gz
Source0  : https://files.pythonhosted.org/packages/79/2f/552806e72d8ca94a4ee6645d3fe7208cba0d3394c74c7b178fb4eac29fa7/jupyter_events-0.9.1.tar.gz
...
%prep
%setup -q -n jupyter_events-0.9.1
cd %{_builddir}/jupyter_events-0.9.1
pushd ..
cp -a jupyter_events-0.9.1 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1710540181
